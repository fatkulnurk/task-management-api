...
// Source: internal/modules/tasks/domain/service.go
//
...
func (m *MockService) Assign(arg0 context.Context, arg1 domain.AssignInput) (domain.Task, error) {
	m.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) Assign(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Assign", reflect.TypeOf((*MockService)(nil).Assign), arg0, arg1)
}

// Create mocks base method.
func (m *MockService) Create(arg0 context.Context, arg1 domain.CreateInput) (domain.CreateOutput, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) Delete(arg0 context.Context, arg1 domain.DeleteInput) error {
	m.ctrl.T.Helper()
...
func (m *MockService) Get(arg0 context.Context, arg1 domain.GetInput) (domain.Task, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) List(arg0 context.Context, arg1 domain.ListInput) ([]domain.Task, int, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) Update(arg0 context.Context, arg1 domain.UpdateInput) (domain.Task, error) {
	m.ctrl.T.Helper()
